...
class Telephone:
    ...
    def __init__(self):
        self.poleList = [pole.Pole(2.5, 2.5), pole.Pole(3.5, 2.5), pole.Pole(4.5, 2.5)]
        self.lineList = []
        ...
        self.left_mic = mic.Mic(0, 4, True)
        self.right_mic = mic.Mic(WIDTH - mic.WIDTH, 0.5, False)
        self.left_ear = ear.Ear(0, 1.5, True)
        self.right_ear = ear.Ear(WIDTH - ear.WIDTH, 3, False)
